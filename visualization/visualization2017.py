...
data_2017 = data_2017.dropna(subset=["chemical_spending", "inspection_rate"])

# Sort states by chemical spending for better visualization
data_2017 = data_2017.sort_values(by="chemical_spending", ascending=False)
...
ax1.bar(data_2017["state"], data_2017["chemical_spending"], alpha=0.7, label="Chemical Spending ($)", color="tab:blue")
...
# Title and Grid
plt.title("Chemical Spending vs. Inspection Rate by State (2017)")
