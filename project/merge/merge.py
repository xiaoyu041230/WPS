...
def merge_cleaned_datasets():
    ...
    inspections = pd.read_csv("../cleanedData/cleaned_inspection_and_violation_data.csv")
    pesticides = pd.read_csv("../cleanedData/cleaned_pesticide_data.csv")
    labor = pd.read_csv("../cleanedData/cleaned_labor_data.csv")
